    ...
    export default {
      ...
      methods: {
        ...
        fetchSearchNews() {
          if(this.searchword !== '')
          {
            this.apiUrl = 'https://newsapi.org/v2/top-headlines?country=th&category=business&apiKey=536edac0b8694b6298e1bca491b708a3' + this.searchword +
        ...
        fetchTopNews() {
          this.apiUrl = 'https://newsapi.org/v2/top-headlines?country=th&category=business&apiKey=536edac0b8694b6298e1bca491b708a3' + this.country +
                          '&pageSize=' + this.maxPerPage +
                          '&apiKey=' + this.apiKey;
          this.isBusy = true;
          this.searchword = '';
